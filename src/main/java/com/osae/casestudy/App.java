...
public class App {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println(
					"** Currently have file: " + Activities.filePath + " on record, Do you wish to proceed? (Y/N) ");
			...
			print.print();
			log.info("Complete .. " + print.getTimetableFile().getCanonicalPath());

			System.out.println("Complete .. " + print.getTimetableFile().getCanonicalPath());
